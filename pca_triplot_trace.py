...
SCORES_CSV = 'pca_scores_Trace_elements.csv'
CLUSTER_CSV = 'cluster_assignments_Trace_elements.csv'
OUT_PNG = 'pca_triplot_trace_elements.png'
...
ax.set_title('PCA Triplot (Trace elements): PC1 vs PC2 vs PC3', fontsize=20)
